...
class AsyncHttpManager:
    def __init__(self: "AsyncHttpManager") -> None:
        self._loop: asyncio.AbstractEventLoop | None = None
        self._client: httpx.AsyncClient | None = None

    def get_loop(self: "AsyncHttpManager") -> asyncio.AbstractEventLoop:
    ...
    def get_client(self: "AsyncHttpManager") -> httpx.AsyncClient:
